 ...
 *
 * A FileSearchProvider is the more powerful of two ways to implement file search in TBS-IDE. Use a FileSearchProvider if you wish to search within a folder for
