		...
		configurationRegistry.registerConfiguration({
			...
			properties: {
				'terminal.explorerKind': {
					...
					enumDescriptions: [
						nls.localize('terminal.explorerKind.integrated', "Use TBS-IDE's integrated terminal."),
				...
				'terminal.sourceControlRepositoriesKind': {
					...
					enumDescriptions: [
						nls.localize('terminal.sourceControlRepositoriesKind.integrated', "Use TBS-IDE's integrated terminal."),
