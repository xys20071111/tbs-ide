...
/**
 * Allows webviews to monitor when an element in the TBS-IDE editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. TBS-IDE needs to see this
