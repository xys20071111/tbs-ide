	...
	private getTunnelCommandLocation() {
		if (!this._tunnelCommand) {
			...
			if (isMacintosh) {
				...
				// appRoot = C:\Users\<name>\AppData\Local\Programs\Microsoft TBS-IDE Insiders\resources\app
				// bin = C:\Users\<name>\AppData\Local\Programs\Microsoft TBS-IDE Insiders\bin
