...
export class ToggleTabFocusModeAction extends Action2 {
	...
	constructor() {
		super({
			...
			title: { value: nls.localize({ key: 'toggle.tabMovesFocus', comment: ['Turn on/off use of tab key for moving focus around TBS-IDE'] }, 'Toggle Tab Key Moves Focus'), original: 'Toggle Tab Key Moves Focus' },
